import { AppWindow, ArchiveRestore, ArrowLeft, CircleUserRound, Database, Download, FolderOpen, Info, LoaderCircle, Moon, MoonStar, Monitor, Pencil, Power, RefreshCw, Save, SlidersHorizontal, Sun, Upload } from "lucide-react";
